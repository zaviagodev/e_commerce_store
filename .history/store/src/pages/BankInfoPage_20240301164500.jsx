  ...
  function handleChange(event){
    ...
    return (
        <div className='py-10 w-full'>
            {modalOpen && (
                <Modal open={() => openModal(true)} isOpen={modalOpen} close={() => openModal(false)} >
                    <p>Are you sure you want to navigate away?</p>
                    <SfButton onClick={handleStay}>Stay</SfButton>
                    <SfButton onClick={handleContinue}>Continue</SfButton>
                </Modal>
            )}
            <div className='max-w-[513px] mx-auto flex flex-col gap-y-12 p-8 rounded-[30px]'>
                ...
                <Modal open={setModalOpen} isOpen={isModalOpen} close={setModalOpen}>
