    ...
    <>
      <div ref={refs.setReference} className="hidden lg:block relative">
        <div
          ...
          className={classNames("flex gap-2 justify-between items-center relative font-normal px-3 py-2 typography-text-base cursor-pointer transparent", {'text-white w-max !p-2': !submenu})}
          tabIndex={0}
        ...
        >
          {options.map((option) => (
            <SfListItem
              ...
              role="option"
              tabIndex={0}
              className={`${option.children.length > 0 ? 'p-[0!important]' : 'block !px-3'} text-maingray hover:text-black`}
