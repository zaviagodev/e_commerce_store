...
const MyAccountSection = ({children}) => {
  ...
  const menus = [
    {title:'Account Details', link:'/profile', icon:''},
    {title:'My Addresses', link:'/my-addresses', icon:''},
    {title:'My Orders', link:'/order-history', icon:''},
  ]
  return (
    <main className='main-section'>
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-12'>
        <div className='lg:col-span-1 flex flex-col w-[150px] mx-auto'>
          <div className='flex flex-col gap-y-4'>
            <img
              ...
              alt="User Image"
            />
            <p className="font-bold text-[24px] leading-5">{currentUser}</p>
          </div>
        ...
        <div className='lg:col-span-2 w-3/4 mx-auto'>
          {children}
        </div>
      </div>
    </main>
